...
# Full-screen window
cv2.namedWindow("Combined Detection", cv2.WND_PROP_FULLSCREEN)
cv2.setWindowProperty("Combined Detection", cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
...
while True:
    ...
    # Process head pose
    if time.time() - start_time <= 5:  # Calibration period
    ...
    # Display the combined output (full screen)
